...
public:
    SimulationDashboard(const pipeframe::GraphicsResourceService&, pipeframe::FontHandle, const std::string& title,
                        const pipeframe::ui::ViewTheme& theme = pipeframe::ui::ViewTheme::Dark());
    ~SimulationDashboard();
