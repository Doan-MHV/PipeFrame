# Ant — PipeFrame reference project

Open `project.pipeframe` in SimulationWorkbench and choose **Build & Reload** for the
current host (ABI 13). R6 introduced editor-authored environments and the complete
...
| Connect the project to the host | `Source/Runtime/AntSimulationRuntime.*`, `AntUIHost.cpp` | ProjectRuntime and neutral SimulationDashboard |
