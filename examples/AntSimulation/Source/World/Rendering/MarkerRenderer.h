...
public:
    static constexpr std::size_t UpdateDecimation{
        20
    };

    static constexpr float MarkerColorPower{
        0.025f
    };

    static constexpr float MarkerHalfSize{
        1.5f
    };

    explicit MarkerRenderer(
...
private:
    ...
    [[nodiscard]]
    static std::uint8_t ToColorChannel(
        float value
    );
