...
inline std::vector<pipeframe::Vertex2D> BuildSignalBeaconGeometry(
    const pipeframe::Transform2DComponent &transform,const SignalBeaconComponent &settings) {
    ...
    return {{point(radius,0),settings.color,{}}, {point(-radius,-radius*.65f),settings.color,{}},
