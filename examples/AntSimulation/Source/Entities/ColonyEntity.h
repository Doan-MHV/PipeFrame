...
public:
    ...
    void OnInstantiated(const pipeframe::SceneObject &object) const override {
        ...
        settings.red = color.r; settings.green = color.g; settings.blue = color.b;
    }
private:
    ColonyId id; pipeframe::Vector2f position; pipeframe::Color color;
    AntConfiguration configuration; std::size_t samples;
};
}
