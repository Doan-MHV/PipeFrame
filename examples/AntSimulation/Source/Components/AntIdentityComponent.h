...
struct AntIdentityComponent {
    ...
    static auto Schema() {
        ...
        return ComponentSchema<AntIdentityComponent>("ant.identity","Ant Identity").Required()
        ...
        .ReadOnly({.key="color", .displayName="Color", .kind=K::Color, .defaultValue=Color{}}, &AntIdentityComponent::color);
    }
