#ifndef BASIC_SIMULATION_POPULATION_SPATIAL_GRID_H
#define BASIC_SIMULATION_POPULATION_SPATIAL_GRID_H
...
class PopulationSpatialGrid final {
public:
    struct CellRange {
        int minimumColumn = 0;
        int maximumColumn = -1;
        ...
        bool IsEmpty() const {
            return maximumColumn < minimumColumn ||
...
private:
    ...
    sf::Vector2i GetCellCoordinates(
        sf::Vector2f position) const;
